...
from utils import KG_View, question2info, mention2entity, advogato_data_KG_target, source_template, target_template, get_paths, \
...
def show_demo():
    ...
    if entity == '':
        ...
        baidu = {}
        baike_url = get_baidu_url(entity)  # 百度百科的url
        baidu['url'] = baike_url
        baidu['entity'] = entity
        if result:
            print("已经有这个文件了")
